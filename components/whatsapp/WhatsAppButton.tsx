...
export function WhatsAppButton({ phone, template, args, label = "Send WhatsApp" }: Props) {
  ...
  return (
    <a
      ...
      className="inline-flex items-center gap-1.5 rounded-md bg-[#22C55E] px-3 py-1.5 text-sm font-medium text-white hover:opacity-90 transition"
    >
